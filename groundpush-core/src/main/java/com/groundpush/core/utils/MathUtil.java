...
public class MathUtil {
    ...
    public static BigDecimal divide(BigDecimal v1, BigDecimal v2) {
        return v1.divide(v2, DEF_DIV_SCALE, RoundingMode.UP);
    }
    ...
    public static Integer subtract(Integer v1, Integer v2) {
        ...
        return subtract(b1, b2).intValue();
    }
    ...
    public static Integer multiply(Integer v1, Integer v2) {
        ...
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        return multiply(b1, b2).intValue();
    }
    ...
    public static Integer divide(Integer v1, Integer v2, Integer scale) {
        ...
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        return divide(b1, b2, scale).intValue();
    }
     ...
     * @return 两个参数的和(String)
     */
    public static Integer sum(Integer v1, Integer... valList) {
        if (v1 == null) {
            v1 = 0;
        }
        if (null == valList || valList.length == 0) {
     ...
     * @return
     */
    public static Integer avg(Integer... valList) {
        if (null != valList && valList.length != 0) {
//            return divide(sum(0, valList),valList);
        }
        return 0;
    }
    ...
    public static String max(String v1, String... valList) {
        ...
        for (String val : valList) {
            if (StringUtils.isNotBlank(val) && new BigDecimal(val).compareTo(maxBd) > 0) {
    ...
    public static String min(String v1, String... valList) {
        ...
        for (String val : valList) {
            if (StringUtils.isNotBlank(val) && new BigDecimal(val).compareTo(minBd) < 0) {
