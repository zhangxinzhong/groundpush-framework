...
public interface CustomerMapper {
     ...
     * @param customer
     */
    @Insert(" insert into t_customer(parent_id, nick_name, img_uri, status, invite_code, reputation, created_time) values (#{parentId},#{nickName},#{imgUri},1,#{inviteCode},#{reputation},#{createdTime}) ")
