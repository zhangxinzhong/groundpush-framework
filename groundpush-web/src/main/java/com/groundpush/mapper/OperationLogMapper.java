...
public interface OperationLogMapper {
    ...
    @Insert(" insert into t_operation_log(method, args,created_by, describe, operation_type, run_time, type, created_time) values (#{method},#{args},#{createdBy},#{describe},#{operationType},#{runTime},#{type},current_timestamp) ")
